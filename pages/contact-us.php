...
<body>
    ...
    <div class="container bg-light banner">
        ...
        <a href="#" class="btn btn-success">Call</a>
    </div>
            ...
            <form>
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control" placeholder="ex: gaizkiaadeline04@gmail.com">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="">FullName</label>
                        <input type="text" class="form-control" placeholder="ex: Gaizkia Adeline Atmaka">
                    </div>
